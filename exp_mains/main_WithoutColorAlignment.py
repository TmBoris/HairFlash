...
from hair_swap import HairFlash1WithoutColorMask, get_parser


def main(model_args, args):
    hair_flash = HairFlash1WithoutColorMask(model_args)
    ...
    for exp in tqdm(experiments):
        ...
        final_image = hair_flash.swap(face_path, shape_path, color_path, benchmark=args.benchmark, exp_name=exp_name)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='HairFlash evaluate')
